...
Проект 2: Когортный анализ онлайн-кинотеатра с помощью SQL
 ...
 - Вывод 1: Рассчитали LT, LTR, Долю постоянных затрат на 1 пользователя, LTV для каждой когорты пользователей
 - Вывод 2: Смоделировали ситуацию при которой цена подписки выросла бы на 10% при неизменном количестве клиентов.  В таком случае получили бы увеличение выручки на 12%.
